...
mysql> select * from t_orders_bigdata t where t.customer_num = 'CUST000002';
10000 rows in set (2.09 sec)
```
...
mysql> select order_id, amount from t_orders_bigdata t where t.customer_num = 'CUST000002';
10000 rows in set (0.11 sec)
```
